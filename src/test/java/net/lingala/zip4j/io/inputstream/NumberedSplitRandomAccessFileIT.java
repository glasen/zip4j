...
public class NumberedSplitRandomAccessFileIT extends AbstractIT {
    ...
    public void testOpenInWriteModeThrowsException() throws IOException {
        ...
        try (var empty = new NumberedSplitRandomAccessFile(getTestFileFromResources("sample.pdf"), RandomAccessFileMode.WRITE.getValue())) {
            empty.read();
        }
    }
    ...
    public void testWriteIntThrowsUnsupportedOperationException() throws IOException {
        ...
        try (NumberedSplitRandomAccessFile numberedSplitRandomAccessFile = new NumberedSplitRandomAccessFile(
